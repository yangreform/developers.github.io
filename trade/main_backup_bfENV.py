...
IB_PORT = 4001
IB_CLIENT_ID = 100
WEBHOOK_PASSPHRASE = 'My123'
TARGET_ACCOUNT = "" # 若有多個帳戶，請填寫您的目標帳戶代碼，留空則不過濾帳戶
...
api = sj.Shioaji()
accounts = api.login("Cn7Sc1YFeLRQSDD1MoAN1HWEqZnnwNL2j5moqvvbzpoa", "EB3FvkRvY9J7fm4r5zLEBeB1CZmz4mS7cxMVBc5JzVzK")
api.activate_ca(
    ca_path="Sinopac.pfx",
    ca_passwd="C121009604",
)
# ==========================================
...
def webhook():
    ...
    if symbol == 'TMF': # 假設 I 代表國內期貨
        ...
        try:
            ...
            # ======== 1. 檢查特定商品與庫存狀況 ========
            CHECK_SYMBOLS = ['TMF','VXM','1OZ','MBT','MJY','M6E','MNG','MHG','M2K','MES','MNQ']    #long only
            ...
            def get_target_expiry(sym, act):
                ...
                if sym == "MHNG":
                    return "202608" if act == "BUY" else "202609"
...
if __name__ == '__main__':
    ...
    print("📈 IBKR 交易核心已啟動於獨立 Port 5500")
